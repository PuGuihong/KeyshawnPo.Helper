...
namespace KeyshawnPo.Helper.Lib
{
    ...
    public class StringsHelper
    {
        ...
        /// 静态变量，用于保存类的实例
        /// </summary>
        private static StringsHelper instance;
        /// <summary>
        /// 线程标志，确保线程同步
        /// </summary>
        ...
        /// 定义公共属性，使全局均可访问
        /// </summary>
        public static StringsHelper Instance
        {
            get
            {
                //实例不存在则创建
        ...
        /// <returns>字符串</returns>
        public static string GetStrByLen(string source, int len)
        {
