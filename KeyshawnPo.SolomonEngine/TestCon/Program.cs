...
namespace TestCon
{
    class Program
    {
        ...
        {
            string strHtml = @"<p style='color:red;text-align:center;background-color:#000000;'> 测试pdf!<p><div style='width:150px;height:150px;background-color:blue;'>测试内容</div>";
            //string htmlUrl = "https://wkhtmltopdf.org/downloads.html";
            try
            {
                /// 把 HTML 文本内容转换为 PDF
                HtmlTextConvertToPdf(strHtml, @"D:\001.pdf");
            }
            catch (Exception ex)
            {
            ...
            /// 把 HTML 文件转换为 PDF
            //HtmlConvertToPdf(htmlUrl, @"D:\002.pdf");
        }
